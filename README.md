...
На данный момент я студентка Яндекс.Практикум. В одном из учебных проектов погрузилась в React, Redux, TypeScript с головой, собираюсь и дальше продолжать изучать данный стек. С другой стороны, с нетерпением жду сприната по бэкенду, уверена будет сложно и интересно :fire:
